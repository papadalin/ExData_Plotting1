...
plot(rtt,r3,type="l",ylab="Global Active Power",xlab="",cex.lab=0.8,cex.main=0.8)
plot(rtt,r5,type="l",ylab="Voltage",xlab="datetime",cex.lab=0.8,cex.main=0.8)
...
plot(rtt,r4,type="l",ylab="Global_reactive_power",xlab="datetime",cex.lab=0.8,cex.main=0.8)
